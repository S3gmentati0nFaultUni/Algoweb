...
\title{
    Dispense per il corso di algoritmica per il web\vspace{5mm}\\
    \small Revisione delle dispense a opera di Alessandro Biagiotti
}
...
% Chapters
\include{Chapters/NozioniDiBase}
\include{Chapters/Crawling}
...
\include{Chapters/Punteggi_endogeni}
