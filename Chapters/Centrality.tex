...
\end{equation}
Dove $\overline{A}$ é ancora la matrice di adiacenza del grafo $l_1$-normalizzata, $\alpha \in [0\dots1)$ é un \textit{damping factor}, come quello visto per l'indice di Katz, \textbf{v} é un vettore di preferenza (che deve essere una distribuzione). Questa definizione appare nel paper di Brin e Page su Google % INSERIRE LA CITAZIONE %
