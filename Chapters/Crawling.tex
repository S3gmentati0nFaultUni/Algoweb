...
\begin{enumerate}
    ...
    \item Scandiamo ogni entry di \textbf{S} e A in parallelo (sono entrambi ordinati) e diamo in output gli URL in A corrispondenti alle entry marcatre come utili al passo precedente.
